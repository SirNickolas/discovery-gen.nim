...
type
  ...
  DiscoveryJsonSchema* = object
    ...
    readOnly*: bool
      ...
      ## by the client. If the value is included in a POST, PUT, or PATCH request, it is ignored
      ## by the service.
    repeated*: bool
    ...
    enumDescriptions*: seq[string]
      ## The descriptions for the enums. Each position maps to the corresponding value in the `enum`
      ## array.
    enumDeprecated*: seq[bool]
      ## The deprecation status for the enums. Each position maps to the corresponding value
      ## in the `enum` array.
    location*: string
